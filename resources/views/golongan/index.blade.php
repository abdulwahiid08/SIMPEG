<x-app-layout title="Data Golongan">
    @section('content')
            ...
            <div class="card">
                <div class="card-body mt-3 mb-4">
                    <div class="text-end mb-4">
                        <a href="{{ route('golongan.create') }}" class="btn btn-sm btn-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        <tr class="text-dark">
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('golongan.show', $item->id) }}" class="btn btn-icon btn-sm btn-success mb-2 me-2">
                                        <i class="far fa-folder-open"></i>
                                    </a>
                                     <form action="{{ route('golongan.destroy', $item->id) }}" method="POST" id="data-{{ $item->id }}">
                                        @method('delete')
                                        @csrf
                                    </form>
