<x-app-layout title="History Pengajuan Pangakat">
    @section('content')
        <section class="section">
            <section class="section-header">
                <h1>History Pengajuan Pangkat</h1>
            </section>
                            ...
                            <tr class="text-dark">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <!-- Modal Hapus Golonga -->
                                        <a href="" class="btn btn-icon btn-sm btn-danger mb-2 text-white" data-bs-toggle="modal" data-bs-target="#hapusHistoryModal{{ $item->id }}">
                                            <i class="far fa-trash-alt"></i>
                                        </a>
                                        <div class="modal fade" id="hapusHistoryModal{{ $item->id }}" tabindex="-1" aria-labelledby="hapusHistoryModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="hapusHistoryModalLabel">Hapus Golangan</h5>
